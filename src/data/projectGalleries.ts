...
export const projectGalleries: Record<string, GalleryImage[]> = {
  ...
  'leiloes-retro-games': [
    {
      src: withBaseUrl('images/projects/leiloes-retro-games/02-encerrados.png'),
      alt: 'Lista de leilões encerrados no aplicativo',
      caption: 'Histórico e acompanhamento dos leilões encerrados',
      format: 'mobile',
    },
    {
      src: withBaseUrl('images/projects/leiloes-retro-games/03-detalhes-leilao.png'),
      alt: 'Detalhes de um leilão no aplicativo',
      caption: 'Informações, valores e situação de cada item',
      format: 'mobile',
    },
    {
      src: withBaseUrl('images/projects/leiloes-retro-games/04-cadastro-leilao.png'),
